...
/***/ function(module, exports, __webpack_require__) {
	...
	var Firebase = __webpack_require__(157);
	var ReactFireMixin = __webpack_require__(158);
	var QuoteList = __webpack_require__(159);
	var QuoteForm = __webpack_require__(179);
	...
	var App = React.createClass({
	  ...
	  submitQuote: function submitQuote(quote, attribution) {
	    if (quote.trim()) {
	  ...
	  componentWillMount: function componentWillMount() {
	    this.bindAsArray(new Firebase("https://shitmymatessay.firebaseio.com/quotes"), "quotes");
	  },
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(QuoteForm, { onSubmit: this.submitQuote })
	      ),
	      React.createElement(QuoteList, { quotes: this.state.quotes })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var QuoteListItem = __webpack_require__(160);
	...
	module.exports = React.createClass({
	  ...
	  quotes: function quotes() {
	    return this.props.quotes.reverse().map(function (quote, index) {
	      return React.createElement(QuoteListItem, { quote: quote, key: index });
	    });
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  byline: function byline(quote) {
	    var date = new Date(quote.quoted_at).toLocaleDateString();
	    var byline = [quote.attribution, date].filter(Boolean).join(", ");
	    return React.createElement(
	      "small",
	      { key: date, className: "quote-byline list-group-item-text" },
	      "- ",
	      byline
	    );
	  },

	  toggleByline: function toggleByline() {
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      { key: this.props.key, className: "quote-item list-group-item", onClick: this.toggleByline },
	      React.createElement(
	        "h4",
	        { className: "quote-text list-group-item-heading" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  onQuoteChange: function onQuoteChange(e) {
	    this.setState({ quote: e.target.value });
	  },

	  onAttributionChange: function onAttributionChange(e) {
	  ...
	  render: function render() {
	    return React.createElement(
	      "form",
	      { className: "quotes-form", onSubmit: this.handleSubmit },
	      React.createElement(
	        "div",
	        { className: "form-group joined-inputs" },
	        React.createElement(
	          "label",
	          { className: "sr-only", htmlFor: "quote" },
	          "New Quote"
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.placeholders) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js!./application.sass", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js!./application.sass");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "90e2fd38e336a831b05ee45cf081e450.png"
